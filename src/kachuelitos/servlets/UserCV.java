...
/**
 * Servlet implementation class UserCV
 */
@WebServlet("/UserCV")
public class UserCV extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println ("<!DOCTYPE html>\n" + "<html>\n" +
				...
				"<li><a href='/Kachuelitos/UserWorks' title='Home'>Mis Trabajos</a></li>\n"+
				"<li><a href='/Kachuelitos/UserCV' title='Home' class='current'>Mi CV</a></li>\n"+
				"</ul>\n"+
				"</div>\n"+
				"<div id='content'>\n"+
